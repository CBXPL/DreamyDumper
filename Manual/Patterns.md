...
| **SteamOverlay::ResizeBuffers** | `40 53 55 56 57 41 54 41 56 51 57 48 83 EC ? 48 8B E2 48 8B E9` | `GameOverlayRenderer64.dll` |
| **SteamOverlay::SwapChain (Creation)** | `40 53 55 56 57 48 83 EC 28 48 8B F9 49 8B F1 48 8D 0D 7A 8C 08 00 49 8B D8 48 8B EA E8 FF ? ? ? 48 8D 0D ? D6 0C 00 E8 93 99 FD FF 48 8D 0D ? D7 0C 00 E8 D7 D3 FD FF 48 8D 0D ? D7 0C 00 E8 0B 80 FE FF 48 8B 05 2C E0 0C ? 4C 8B CE 4C 8B C3 48 8B D5 48 8B CF FF D0 8B D8 85 C0 78 18 48 85 F6 74 13 48 83 3E 00 74 0D 48 8B D5 48 8B CE E8 FA F8 FF FF 8B C3 48 83 C4 28 5F 5E 5D 5B C3` | `GameOverlayRenderer64.dll` |
