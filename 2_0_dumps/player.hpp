...
namespace dreamydumper_player {
    // m_iHealth Info
    inline const char* m_iHealth_location = "0x42D5C2";
    ...
    // m_iTeamNum Info
    inline const char* m_iTeamNum_location = "0x42DBD6";
    ...
    // m_hPawn Info
    inline const char* m_hPawn_location = "0x89D8B2";
    ...
    // m_hPlayerPawn Info
    inline const char* m_hPlayerPawn_location = "0x7FE197";
    ...
    // m_lifeState Info
    inline const char* m_lifeState_location = "0x42F333";
    inline const char* m_lifeState_pattern = "05 E6 76 54 01 C7 45 C7 ?? ?? ?? ?? 4C 8D 4D";
    inline constexpr int m_lifeState_offset = 860;
    inline const char* m_lifeState_hex = "0x35C";

    // m_vecAbsVelocity Info
    inline const char* m_vecAbsVelocity_location = "0x42DE52";
    ...
    inline const char* m_iszPlayerName_location = "0x7FFFC9FD4690";
    inline const char* m_iszPlayerName_pattern = "STATIC_DATA_TABLE";
    inline constexpr int m_iszPlayerName_offset = 1784;
    inline const char* m_iszPlayerName_hex = "0x6F8";

    // m_MoveType Info
    inline const char* m_MoveType_location = "0x42E482";
    inline const char* m_MoveType_pattern = "41 08 C6 01 08 C7 41 10 ?? ?? ?? ?? 66 89 69";
    inline constexpr int m_MoveType_offset = 1325;
    inline const char* m_MoveType_hex = "0x52D";

    // m_pItemServices Info
    inline const char* m_pItemServices_location = "0x42F66A";
    inline const char* m_pItemServices_pattern = "05 1E 0B E4 01 C7 45 C7 ?? ?? ?? ?? 66 44 89";
    inline constexpr int m_pItemServices_offset = 5088;
    inline const char* m_pItemServices_hex = "0x13E0";

    // m_pGameSceneNode Info
    inline const char* m_pGameSceneNode_location = "0x7FFFC9F9E0F0";
    ...
    // m_fFlags Info
    inline const char* m_fFlags_location = "0x42DD12";
