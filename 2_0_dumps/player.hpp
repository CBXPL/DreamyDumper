...
namespace dreamydumper_player {
    // m_iHealth Info
    inline const char* m_iHealth_location = "0x42CF82";
    ...
    // m_iTeamNum Info
    inline const char* m_iTeamNum_location = "0x42D596";
    ...
    // m_hPawn Info
    inline const char* m_hPawn_location = "0x89BF62";
    ...
    // m_hPlayerPawn Info
    inline const char* m_hPlayerPawn_location = "0x7FC907";
    ...
    // m_lifeState Info
    inline const char* m_lifeState_location = "0x42ECF3";
    inline const char* m_lifeState_pattern = "05 AE FF 53 01 C7 45 C7 ?? ?? ?? ?? 4C 8D 4D";
    inline constexpr int m_lifeState_offset = 860;
    inline const char* m_lifeState_hex = "0x35C";

    // m_vecAbsVelocity Info
    inline const char* m_vecAbsVelocity_location = "0x42D812";
    ...
    inline const char* m_pGameSceneNode_location = "0x7FF9DC0753D0";
    ...
    // m_fFlags Info
    inline const char* m_fFlags_location = "0x42D6D2";
