...
namespace dreamydumper_player {
    // m_iHealth Info
    inline const char* m_iHealth_location = "0x42CF02";
    ...
    // m_iTeamNum Info
    inline const char* m_iTeamNum_location = "0x42D516";
    ...
    // m_hPawn Info
    inline const char* m_hPawn_location = "0x89A7D2";
    ...
    // m_hPlayerPawn Info
    inline const char* m_hPlayerPawn_location = "0x7FB177";
    ...
    // m_lifeState Info
    inline const char* m_lifeState_location = "0x42EC73";
    inline const char* m_lifeState_pattern = "05 86 DB 53 01 C7 45 C7 ?? ?? ?? ?? 4C 8D 4D";
    inline constexpr int m_lifeState_offset = 860;
    inline const char* m_lifeState_hex = "0x35C";

    // m_vecAbsVelocity Info
    inline const char* m_vecAbsVelocity_location = "0x42D792";
    ...
    inline const char* m_pGameSceneNode_location = "0x7FFC95E63450";
    ...
    // m_fFlags Info
    inline const char* m_fFlags_location = "0x42D652";
