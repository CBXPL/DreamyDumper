...
namespace cs2_dumper {
    namespace offsets {
        ...
        namespace client_dll {
            constexpr std::ptrdiff_t dwCSGOInput = 0x2338DB0;
            constexpr std::ptrdiff_t dwEntityList = 0x24C9FB0;
            constexpr std::ptrdiff_t dwGameEntitySystem = 0x24C9FB0;
            constexpr std::ptrdiff_t dwGameEntitySystem_highestEntityIndex = 0x2090;
            constexpr std::ptrdiff_t dwGlobalVars = 0x20454E0;
            constexpr std::ptrdiff_t dwGlowManager = 0x2321018;
            constexpr std::ptrdiff_t dwLocalPlayerController = 0x2303760;
            constexpr std::ptrdiff_t dwLocalPlayerPawn = 0x2050630;
            constexpr std::ptrdiff_t dwPlantedC4 = 0x2332928;
            constexpr std::ptrdiff_t dwPrediction = 0x2050540;
            constexpr std::ptrdiff_t dwSensitivity = 0x2321A78;
            constexpr std::ptrdiff_t dwSensitivity_sensitivity = 0x58;
            constexpr std::ptrdiff_t dwViewAngles = 0x2339438;
            constexpr std::ptrdiff_t dwViewMatrix = 0x2329930;
            constexpr std::ptrdiff_t dwViewRender = 0x2329B48;
            constexpr std::ptrdiff_t dwWeaponC4 = 0x22A2050;
        }
        // Module: engine2.dll
        ...
        namespace soundsystem_dll {
            constexpr std::ptrdiff_t dwSoundSystem = 0x512350;
